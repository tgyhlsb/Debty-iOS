...
@interface DTCoreDataTableViewController : DTViewController <NSFetchedResultsControllerDelegate, UITableViewDataSource, UITableViewDelegate>
...
@property (nonatomic) BOOL shouldDisplaySectionsIndex;
